export const aiTools = [
  {
    ...
    items: [
      ...
      { name: '千问', url: 'https://python4office.cn/ads/ai-nav/ali/Qwen/01-%E7%BE%8E%E5%A5%B3%E5%80%92%E6%8C%82%E9%87%91%E9%92%A9%E6%80%8E%E4%B9%88%E5%AE%9E%E7%8E%B0%E7%9A%84%EF%BC%9F%E5%8E%9F%E6%9D%A5%E6%98%AF%E7%94%A8%E5%8D%83%E9%97%AEAPP%E7%9A%84AI%E7%89%B9%E6%95%88%E4%B8%80%E9%94%AE%E7%94%9F%E6%88%90%E7%9A%84/', desc: '阿里AI大模型', icon: '🏗️' },
      { name: 'DeepSeek', url: 'https://chat.deepseek.com', desc: '深度求索AI 推理能力强', icon: '🔍' },
      { name: 'Grok', url: 'https://x.com/i/grok', desc: 'xAI推出的AI对话助手', icon: '🌌' },
      { name: 'Kimi', url: 'https://kimi-bot.com/activities/zh-cn/viral-referral/share?scenario=subscribe&from=share_poster&invitation_code=TZQFL2', desc: '月之暗面AI 超长上下文', icon: '🌙' },
      ...
      { name: 'Moonshot', url: 'https://kimi-bot.com/activities/zh-cn/viral-referral/share?scenario=subscribe&from=share_poster&invitation_code=TZQFL2', desc: 'Kimi API平台', icon: '🌕' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Kimi文档', url: 'https://kimi-bot.com/activities/zh-cn/viral-referral/share?scenario=subscribe&from=share_poster&invitation_code=TZQFL2', desc: 'Kimi处理文档', icon: '🌙' },
      ...
      { name: '墨刀AI', url: 'https://modao.cgref.cn/s/5ln1qj3erw', desc: '极速生成PRD文档、原型图、PPT、图表的智能平台', icon: '✏️' },
      { name: '超级简历WonderCV', url: 'https://wondercv.cgref.cn/s/zdkjoy9e1r', desc: '面向应届生和AI小白的智能求职平台', icon: '📄' },
      { name: 'UP简历', url: 'https://upcv.tech/?utm=cg&cgv=9we2rzwkgo', desc: 'AI帮助用户找工作的求职平台，覆盖求职全流程', icon: '📋' },
      { name: 'AiPPT插件', url: 'https://aippt-plugin.cgref.cn/s/20epp9dew1', desc: '内嵌于Office和WPS的智能化PPT创作工具', icon: '📊' },
      { name: 'iSlide PPT', url: 'https://islide.cgref.cn/s/rpexy6vk90', desc: 'AI一键生成PPT，内置9大资源库', icon: '🎨' },
    ]
  },
  {
    category: 'AI绘画',
    items: [
      ...
      { name: 'LiblibAI在线', url: 'https://liblib.cgref.cn/s/2znrw0okr7', desc: '一站式多模态AI创作平台，覆盖图片、视频生成', icon: '🌈' },
      ...
      { name: '星流', url: 'https://xingliu.cgref.cn/s/1zn5oxmeqm', desc: '面向创作者、设计师的一站式国产AI视觉创作平台', icon: '🌟' },
      { name: '白日梦', url: 'https://aibrm.cgref.cn/s/59ng4gjnr2', desc: 'AI视频创作类AIGC创作平台', icon: '💭' },
      { name: '01Agent', url: 'https://01agent.net/?utm=cg&cgv=rpexy6zk90', desc: '全流程内容创作智能体，专为国内主流平台优化', icon: '🤖' },
      { name: 'LibTV', url: 'https://libtv.cgref.cn/s/9omkl4jn4d', desc: '专业级一站式AI视频创作平台', icon: '🎬' },
    ]
  },
  {
    category: 'AI编程',
    items: [
      ...
      { name: 'Qoder', url: 'https://help.aliyun.com/zh/lingma/product-overview/qoder-cn-account-and-subscription/?scm=20140722.S_help@@%E6%96%87%E6%A1%A3@@3034874._.ID_help@@%E6%96%87%E6%A1%A3@@3034874-RL_QoderCN%E4%B8%AA%E4%BA%BA%E7%89%88%E8%AE%A2%E9%98%85-LOC_2024SPAllResult-OR_ser-PAR1_0bc3b4b417819678032666332e4c17-V_4-PAR3_o-RE_new13-P0_0-P1_0&source=5176.29345612&userCode=t6duaoe1', desc: '阿里Agentic编程', icon: '🚀' },
      { name: 'CodeBuddy', url: 'https://www.codebuddy.ai', desc: '腾讯云AI IDE-国内版', icon: '💡' },
      { name: 'CodeBuddy IDE', url: 'https://www.codebuddy.cn/ide/', desc: '腾讯云AI IDE-国内版', icon: '🧩' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: '立刻MV', url: 'https://lickmv.cgref.cn/s/dqndmwrn2z', desc: 'AI音乐可视化MV生成', icon: '🎤' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Phind', url: 'https://www.phind.com', desc: '开发者AI搜索', icon: '🔍' },
      { name: 'Kimi', url: 'https://kimi-bot.com/activities/zh-cn/viral-referral/share?scenario=subscribe&from=share_poster&invitation_code=TZQFL2', desc: 'AI助手 联网搜索', icon: '🌙' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: '讯飞智作', url: 'https://xfzhizuo.cgref.cn/s/l41ev8dkv8', desc: '基于语音合成技术的AI数字人音视频创作平台', icon: '🎙️' },
      ...
      { name: '音述AI', url: 'https://yinshu.cgref.cn/s/qmno24zk29', desc: 'AI音乐创作与声音分享社区', icon: '🎵' },
    ]
  },
  {
    category: 'AI开源项目',
    items: [
      ...
      { name: '码上飞', url: 'https://codeflying.cgref.cn/s/20epp94ew1', desc: '一站式AI应用开发智能体，可生成小程序、APP、网站', icon: '🚀' },
    ]
  },
  {
    category: 'AI设计',
  ...
  },
  {
    ...
    items: [
      ...
      { name: '切问学术', url: 'https://qiewenpaper.cgref.cn/s/ogewmd4np2', desc: '复旦NLP学术智能体，论文检索+全自动复现', icon: '🎓' },
      ...
      { name: '沁言学术', url: 'https://qinyanai.cgref.cn/s/3mnz8w7no1', desc: 'AI学术全流程工具，覆盖查读写闭环', icon: '📚' },
      { name: 'SpeedAI', url: 'https://speedai.cgref.cn/s/3mnz8wjno1', desc: 'AIGC检测、降重降AI平台', icon: '⚡' },
    ]
  },
  {
    category: 'AI效率工具',
    items: [
      ...
      { name: 'Loomy', url: 'https://loomy.cgref.cn/s/j7n6gjje1g', desc: '讯飞桌面AI助理，自媒体/办公/盯盘一站搞定', icon: '🦄' },
  ...
  },
  {
    category: '赞助推广',
    items: [
      { name: 'LiblibAI', url: 'https://liblib.cgref.cn/s/2znrw0okr7', desc: '中国领先的AI创作平台', icon: '🖼️', badge: '赞助' },
      { name: 'LibTV', url: 'https://libtv.cgref.cn/s/9omkl4jn4d', desc: '专业级一站式AI视频创作平台', icon: '🎬' },
      { name: '星流 (Xingliu)', url: 'https://xingliu.cgref.cn/s/1zn5oxmeqm', desc: '新一代设计Agent', icon: '⭐', badge: '赞助' },
      { name: '墨刀AI', url: 'https://modao.cgref.cn/s/5ln1qj3erw', desc: '激发无限创造力', icon: '🎨', badge: '赞助' },
      { name: '超级简历WonderCV', url: 'https://wondercv.cgref.cn/s/zdkjoy9e1r', desc: 'AI智能简历制作工具', icon: '📝', badge: '赞助' },
      { name: '讯飞智作', url: 'https://xfzhizuo.cgref.cn/s/l41ev8dkv8', desc: 'AI虚拟数字人视频制作', icon: '🎬', badge: '赞助' },
      { name: '音述 (Yinshu)', url: 'https://yinshu.cgref.cn/s/qmno24zk29', desc: '全球最强中文AI音乐创作平台', icon: '🎵', badge: '赞助' },
      { name: 'SpeedAI', url: 'https://speedai.cgref.cn/s/3mnz8wjno1', desc: 'AI Humanizer & AI Detector', icon: '⚡', badge: '赞助' },
      { name: '白日梦AI', url: 'https://aibrm.cgref.cn/s/59ng4gjnr2', desc: 'AI视频创作类AIGC创作平台', icon: '🎥', badge: '赞助' },
      { name: 'AiPPT', url: 'https://aippt-plugin.cgref.cn/s/20epp9dew1', desc: 'AI智能PPT制作软件', icon: '📊', badge: '赞助' },
      { name: 'iSlide', url: 'https://islide.cgref.cn/s/rpexy6vk90', desc: 'PPT模板下载平台', icon: '📑', badge: '赞助' },
      ...
      { name: '二狗PPT', url: 'https://2dogppt.cgref.cn/s/1zn5g7rkqm', desc: '中式职场汇报PPT，AI大纲一键生成', icon: '🐕', badge: '赞助' },
      { name: 'LickMV', url: 'https://lickmv.cgref.cn/s/dqndmwrn2z', desc: 'AI音乐可视化MV生成', icon: '🎤', badge: '赞助' },
