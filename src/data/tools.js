export const aiTools = [
  {
    ...
    items: [
      ...
      { name: 'Kimi', url: 'https://kimi-bot.com/activities/zh-cn/invite/share?scenario=invite&from=share_poster&invitation_code=TZQFL2', desc: '月之暗面AI 超长上下文', icon: '🌙' },
      ...
      { name: 'Moonshot', url: 'https://kimi-bot.com/activities/zh-cn/invite/share?scenario=invite&from=share_poster&invitation_code=TZQFL2', desc: 'Kimi API平台', icon: '🌕' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Kimi文档', url: 'https://kimi-bot.com/activities/zh-cn/invite/share?scenario=invite&from=share_poster&invitation_code=TZQFL2', desc: 'Kimi处理文档', icon: '🌙' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Qoder', url: 'https://www.aliyun.com/product/lingma?userCode=t6duaoe1', desc: '阿里Agentic编程', icon: '🚀' },
      ...
      { name: 'Trae CN', url: 'https://www.trae.cn/work-fission/Q3ECP7CXV5RC', desc: '字节Trae国内版，AI IDE含SOLO模式', icon: '🌟' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Phind', url: 'https://www.phind.com', desc: '开发者AI搜索', icon: '🔍' },
      { name: 'Kimi', url: 'https://kimi-bot.com/activities/zh-cn/invite/share?scenario=invite&from=share_poster&invitation_code=TZQFL2', desc: 'AI助手 联网搜索', icon: '🌙' },
